...
import 'package:travel_guide/feature/details_page/presentation/cubits/activity_details/activity_details_cubit.dart';
...
class DetailsActivitiesRegionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => ActivityDetailsCubit(model.id ?? -1),
                ...
                Stack(
                  children: [
                    ...
                    Positioned(
                      ...
                      bottom: 0,
                      child:
                          TravelGuideTTS(description: model.description ?? ""),
                    ),
                    Positioned(
                      left: 10,
                      top: 50,
                      child: Container(
                        ...
                        child: BlocBuilder<ActivityDetailsCubit,
                            ActivityDetailsState>(
                          buildWhen: (previous, current) {
                            if (current is UpdateLikeLoaded) {
                              model.bookmarked = current.added;
                              return true;
                            }
                            return false;
                          },
